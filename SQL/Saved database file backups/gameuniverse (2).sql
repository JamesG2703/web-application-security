...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2020 at 06:01 PM
...
CREATE TABLE `products` (
  ...
  `ReviewScore` decimal(5,2) NOT NULL COMMENT 'ReviewScore of product',
...
INSERT INTO `products` (`ProductID`, `Name`, `Description`, `Image`, `Category`, `Platform`, `Price`, `ReviewScore`, `AgeRating`) VALUES
(1, 'Doom Eternal', 'A shooter made by bethesda', 0x646f6f6d657465726e616c2e6a7067, 'Shooter', 'PS4', '30.00', '9.20', 18),
(2, 'Animcal Crossing New Horizons', 'The New life simulator by Nintendo', 0x616e696d616c63726f7373696e672e6a7067, 'Simulator', 'Switch', '50.00', '9.00', 3);
...
--
ALTER TABLE `products`
  MODIFY `ProductID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=3;
COMMIT;
